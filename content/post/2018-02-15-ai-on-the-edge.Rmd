...
The figure below shows a simplified view of the vertical, Cloud based sensor data architecture. Data is collected at the end devices, with a grey background, but aggregated and processed at the central Cloud marked in red. 
